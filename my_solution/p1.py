...
llm = ChatOpenAI(
    model="qwen3:8b",  # or "llama3.2", "mistral", "deepseek-coder", etc.
...
game_state = {
    "inventory": {"pen": 2000, "paper": 30000, "pencil_box": 100, "stapler": 20},
    "price": {"pen": 10, "paper": 1, "pencil_box": 250, "stapler": 100},
    "buyer": {"pen": 5, "pencil_box": 1},
    "provider": {"pencil_box": 100, "stapler": 25}
}
